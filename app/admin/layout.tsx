...
/**
 * Layout de TODAS las páginas /admin/*. Provee el sidebar lateral unificado
 * y el guard de sesión (ADMIN/HOSTES, realm sl_session). Las páginas ya NO
 * incluyen su propio nav.
 *
