...
const drawer:   React.CSSProperties = { width: "min(540px, 100%)", maxWidth: "100%", height: "100vh", overflowY: "auto", background: "#1c2628", borderLeft: "1px solid rgba(255,255,255,0.06)", padding: "28px 28px 40px", boxSizing: "border-box" };
