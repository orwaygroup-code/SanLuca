                        ...
                        <div>
                            ...
                            <div style={{ position: "relative" }}>
                                ...
                                <button type="button" onClick={() => setShowLoginPwd((v) => !v)}
                                    style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "rgba(245,241,232,0.4)", padding: 4, lineHeight: 0 }}>
