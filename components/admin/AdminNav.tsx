  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", padding: "12px 20px", borderBottom: "1px solid rgba(255,255,255,0.08)", background: "var(--sl-ink)" }}>
      ...
      <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 12 }}>
        {userName && <span style={{ fontSize: "0.78rem", color: "rgba(245,241,232,0.7)", fontWeight: 600 }}>{userName}</span>}
        <button onClick={onLogout} style={{ padding: "7px 13px", borderRadius: 8, border: "1px solid rgba(255,255,255,0.18)", background: "transparent", color: "rgba(245,241,232,0.7)", fontWeight: 600, fontSize: "0.76rem", cursor: "pointer", fontFamily: "inherit" }}>
          Cerrar sesión
        </button>
      </div>
    </div>
