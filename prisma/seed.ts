...
async function main() {
  ...
  await prisma.dish.createMany({
    data: [
      { name: "Lupo Nero Blanco", description: "IGT Sicilia, Italia. Uvas: Grecanico, Cataratto, Inzolia. Vino blanco elegante y refrescante con notas cítricas, recuerdo a almendra y nueces.", price: 455, categoryId: vinosBlancos.id, position: 1 },
      { name: "Pinot Grigio", description: "I.G.T. Venezie, Italia. Uva: 100% Pinot Grigio. En boca de agradable acidez y frescura. Notas de cítricos, piña, lima, pera y flores.", price: 690, categoryId: vinosBlancos.id, position: 2 },
      ...
      { name: "Illivia Rosado", description: "Salento IGT, Puglia, Italia. Uva: 100% Negroamaro. Aromas a grosellas, granada, fresas, cerezas y rosas.", price: 805, categoryId: vinosBlancos.id, position: 5 },
      { name: "Scaia Blanco", description: "IGT Comune di Colognola Ai Colli. Uva: 55% Garganega – 45% Chardonnay. Fresco con notas frutales como naranja, toronja y recuerdos de minerales.", price: 1100, categoryId: vinosBlancos.id, position: 6 },
  ...
  await prisma.dish.createMany({
    data: [
      ...
      // Botellas
      { name: "Montepulciano D'Abruzzo DOC", description: "Montepulciano d'Abruzzo DOC, Abruzzo, Italia. Uva: 100% Montepulciano. Muy frutal con notas de cerezas, zarzamora y grosellas rojas. Pimienta negra, menta, laurel y vainilla.", price: 660, categoryId: vinoTinto.id, position: 5 },
      ...
      { name: "Illivia Negroamaro", description: "Salento IGT, Puglia, Italia. Uva: 100% Negroamaro.", price: 960, categoryId: vinoTinto.id, position: 7 },
      ...
      { name: "Roccaperciata Rosso", description: "Terre Siciliane IGT, Italia. Uvas: 50% Nero d'Avola, 50% Syrah. Las cerezas negras, ciruelas y grosellas negras ofrecen una marcada intensidad aromática adornada por violetas y suculentas notas lácticas.", price: 710, categoryId: vinoTinto.id, position: 9 },
      { name: "5 Vite", description: "DOC Puglia, Italia. Uvas: Primitivo y Susamaniello. Frutos rojos, ciruela y especias dulces. Elegante con postgusto largo.", price: 1200, categoryId: vinoTinto.id, position: 10 },
      { name: "Quater Vitis Rosso", description: "Terre Siciliane IGT, Italia. Uvas: Nero d'Avola, Perricone, Frappato e Nerello Cappuccio dell'Etna. Crianza de 10 meses. Aromas a grosellas, cerezas negras, higos, moras, arándanos, pimienta negra, coco tostado, vainilla y más.", price: 1500, categoryId: vinoTinto.id, position: 11 },
      { name: "Scaia Rosso", description: "IGT Comune di Colognola Ai Colli, Verona. Uva: 100% Corvina. Elegante, con buen cuerpo y postgusto mediamente largo. Notas florales, frutos del bosque, cereza y ciruela.", price: 1317, categoryId: vinoTinto.id, position: 12 },
      { name: "Villa Santera", description: "Salice Salentino Riserva DOC, Puglia, Italia. Uva: 90% Negroamaro y 10% Malvasia Nera di Lecce. 12 meses de barrica de roble. Intensas notas de arándanos maduros, cerezas, albahaca, eneldo, orégano y eucalipto.", price: 1550, categoryId: vinoTinto.id, position: 13 },
      { name: "Colpo di Zappa", description: "Salice Salentino DOC, Puglia, Italia. Uva: 100% Negroamaro. 12 meses en barrica de roble francés, 12 meses en botella. Sedoso y armónico con aromas de higos, moras, zarzamoras, ciruelas y grosellas negras maduras.", price: 2400, categoryId: vinoTinto.id, position: 14 },
      { name: "Amarone della Valpolicella", description: "DOCG Municipio di Mezzane di Sotto, Monte Garbi, Verona. Uvas: 70% Corvina y Corvinone, 20% Rondinella, 5% Croatina, 5% Oseleta. Apasimento de las uvas por 3 meses.", price: 3350, categoryId: vinoTinto.id, position: 15 },
      ...
      { name: "Marqués de Riscal Reserva Especial XR", description: "DOC Rioja, España. Uva: Tempranillo, Graciano. 26 meses de barrica. Muy expresivo en nariz con notas de regaliz, canela y pimienta negra.", price: 2040, categoryId: vinoTinto.id, position: 17 },
      ...
      { name: "Les Légendes R Rouge", description: "Bordeaux, Francia. Uva: Cabernet Sauvignon y Merlot. 9 meses de crianza en barrica. Intenso y muy expresivo, dominado por aromas de fruta fresca como la grosella roja y la frambuesa.", price: 1200, categoryId: vinoTinto.id, position: 20 },
      { name: "Zuccardi Serie Q", description: "Valle de Uco, Argentina. Uva: 100% Malbec. 12 meses en barrica de roble francés. Complejo aroma de frutos secos maduros, ciruelas, higos y cassis con notas sutiles de tabaco, vainilla y pimienta negra.", price: 1992, categoryId: vinoTinto.id, position: 21 },
    ]
  });
  ...
  await prisma.dish.createMany({
    data: [
      ...
      { name: "Flumen Prosecco", description: "DOC Pramaggiore, Italia. Uva: 100% Glera. Aromas a flores blancas, acacia, melocotón y manzana verde. Fragante y sabroso, con una aterciopelada persistencia.", price: 790, categoryId: vinosEspumosos.id, position: 2 },
    ]
  });
